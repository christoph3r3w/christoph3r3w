	...
	<ul class="headerUl">
		<li class="header-logo">
			<a href="/">
				...
				{#if openAboutMore == true}
					<img class="face-2" src="./25acb22a-22a3-41d5-a0eb-c91529c4c6c8 (Custom).jpg" alt="icon of my face me">

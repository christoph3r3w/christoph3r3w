...
//   private decayFrameId: number | null = null;
...
//     if (!this.isAnimating) {
//       this.isAnimating = true;
//       this.animationFrameId = requestAnimationFrame(() => this.animate(sequenceWidth, needsReset));
//     }
//   };
...
//     }
//     if (this.decayFrameId !== null) {
//       cancelAnimationFrame(this.decayFrameId);
//       this.decayFrameId = null;
//     }
//     this.isAnimating = false;
//   };
// } 
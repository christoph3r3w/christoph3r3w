...
{#snippet Contacts()}
	...
	<div class="text-bubble">
		<span class="contact-links">
			...
			<a href="https://www.linkedin.com/in/christopher-willems-83238b196/" target="_blank" data-title="LinkedIn" aria-label="link to my linkedin">
				<svg
					width="52"
					height="53"
					viewBox="0 0 52 53"
			...
			<a href="https://www.are.na/christopher-willems/channels" target="_blank" data-title="are.na" aria-label="link to my Arena">
			...
			<a href="https://github.com/christoph3r3w" target="_blank" data-title="GitHub" aria-label="link to my github">
				<svg
					width="52"
					height="52"
					viewBox="0 0 52 52"
